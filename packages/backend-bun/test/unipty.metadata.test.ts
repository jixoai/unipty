...
describe("@unipty/backend-bun metadata", () => {
  test("default-exports schema-1 metadata with the declared Backend identity", () => {
  ...
  test("declares only identity/protocol/targets/provenance fields", () => {
  ...
  test("evaluation is side-effect-free: it needs no Bun.Terminal substrate", async () => {
  ...
  test("the entry module is side-effect-free too: import constructs nothing", async () => {
