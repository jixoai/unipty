...
const backend = await autoResolveUniPtyBackend({
  ...
  const toc = [
    { href: '#core', label: 'Core usage' },
    { href: '#acquisition', label: 'Backend acquisition' },
    { href: '#routes', label: 'Official routes' },
    { href: '#metadata', label: 'Metadata protocol' },
    { href: '#browser-limits', label: 'Browser limits' },
  ]
...
>
  ...
  >
    <nav class="flex flex-wrap gap-2 text-xs" aria-label="On this page">
      {#each toc as entry (entry.href)}
        <a
          href={entry.href}
...
<div class="mx-auto grid w-full max-w-[90rem] gap-6 px-4 pt-6 sm:px-6 min-[940px]:grid-cols-3 lg:px-8">
...
<div class="mx-auto w-full max-w-[90rem] px-4 pt-6 sm:px-6 lg:px-8" data-reveal="" use:reveal>
  <SectionCard
    id="core"
    eyebrow="Core usage"
  ...
  >
    <div class="flex flex-col gap-7">
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Construct with a ready Backend</h3>
      ...
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Spawn with structured argv</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
      ...
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">One stream per PTY</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
      ...
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Write with boolean readiness</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
      ...
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Resize</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
      ...
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Terminate and close are non-cascading</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
      ...
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Exit is an independent observation</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
      ...
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Capabilities and error codes</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
      ...
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Dispose the Backend owner</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
...
<div class="mx-auto w-full max-w-[90rem] px-4 pt-6 sm:px-6 lg:px-8" data-reveal="" use:reveal>
  ...
  >
    <div class="flex flex-col gap-7">
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Manual import — the first-class path</h3>
        <CodeBlock code={manualImportCode} lang="ts" meta="manual" />
      </div>

      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">AutoResolve</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
      ...
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Pure resolution and inspection</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
      ...
      <div class="flex flex-col gap-3">
        <h3 class="text-[15px] font-bold tracking-tight">Bundled deployments: explicit manifest</h3>
        <p class="text-muted-foreground text-pretty text-[13px] leading-6">
...
<div
  class="mx-auto w-full max-w-[90rem] px-4 pb-4 pt-6 sm:px-6 lg:px-8"
  data-reveal=""
  use:reveal
>
  <SectionCard
